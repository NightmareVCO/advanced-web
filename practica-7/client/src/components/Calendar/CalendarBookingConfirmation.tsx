    ...
    <div className="flex w-[375px] flex-col items-center gap-5 rounded-large bg-default-50 py-8 shadow-small">
      ...
      <div className="flex flex-col items-center w-full gap-4 px-8">
        <div className="flex flex-col w-full gap-1">
          <p className="font-medium text-small text-default-foreground">Details</p>
          <p className="text-tiny text-default-500">
            30min meeting between Zoey Lang and John Thompson
          </p>
        </div>
        <div className="flex flex-col w-full gap-1">
          <p className="font-medium text-small text-default-foreground">When</p>
          <p className="text-tiny text-default-500">
        ...
        <div className="flex flex-col w-full gap-1">
          <p className="font-medium text-small text-default-foreground">Invited</p>
        ...
        <div className="flex flex-col w-full gap-1">
          <p className="font-medium text-small text-default-foreground">Where</p>
