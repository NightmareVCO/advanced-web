...
public class UserController {
    ...
    public ResponseEntity<UserResponseDTO> createUser(
            @RequestBody UserDTO userDTO, @RequestHeader("Authorization") String token) {
        String jwt = token.substring(7);
        Optional<Claims> claims = jwtService.getClaims(jwt);
        ...
        if (createdUser == null) throw new InternalServerError("Internal Server Error");
    ...
    public ResponseEntity<UserResponseDTO> updateUser(
        ...
        UserResponseDTO updatedUserResponse =
                UserMapper.INSTANCE.userToResponseDto(savedUser.get());
        if (updatedUserResponse == null) throw new InternalServerError("Internal Server Error");
    ...
    public ResponseEntity<UserResponseDTO> deleteUser(
        ...
        if (deletedUser == null) throw new InternalServerError("Internal Server Error");
