...
export const MacbookScroll = ({
	...
	return (
		...
		>
			...
			/>
			{/* Base area */}
			<div className="h-[22rem] w-[40rem] bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
				{/* above keyboard bar */}
	...
	return (
		<div className="relative [perspective:800px]">
			<div
				...
				className="h-[12rem] w-[40rem] bg-[#010101] rounded-2xl p-2 relative"
			>
				<div
					style={{
			...
			<motion.div
				...
				className="h-96 w-[40rem] absolute inset-0 bg-[#010101] rounded-2xl p-2"
			>
...
export const Row = ({ children }: { children: React.ReactNode }) => {
	return (
		<div className="flex gap-[2px] mb-[2px justify-center items-center w-full flex-shrink-0">
			{children}
		</div>
	);
};
